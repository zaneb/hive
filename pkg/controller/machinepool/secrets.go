...
const (
	// legacyWorkerUserDataName is the name of a secret in the cluster used for obtaining user data from MCO prior to 4.10.
	legacyWorkerUserDataName = "worker-user-data"

	// workerUserDataName is the name of a secret in the cluster used for obtaining user data from MCO after 4.10.
	workerUserDataName = "worker-user-data-managed"
)

var (
	versionsUsingLegacyWorkerUserDataName = semver.MustParseRange("<4.10.0")
)
